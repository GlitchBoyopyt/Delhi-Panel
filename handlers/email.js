  ...
  async function sendPasswordResetEmail(email, token) {
    try {
      ...
      const mailOptions = {
        ...
        html: `
          <div style="font-family: Arial, sans-serif; background-color: #0000BB; padding: 20px; border-radius: 8px; max-width: 600px; margin: 0 auto; color: #333;">
            <div style="background-color: #0000FF; padding: 30px; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
